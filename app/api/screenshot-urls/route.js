// Vraci podepsane URL pro screenshoty (token NIKDY v URL)
import { verifySessionToken, createScreenshotSignature } from '../../lib/auth.js'
...
export async function POST(req) {
  try {
    ...
    const { token, sessionId, slots } = body
